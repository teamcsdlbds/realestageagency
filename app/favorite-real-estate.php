...
Lorem ipsum dolor sit, amet consectetur adipisicing elit. Non ipsa excepturi, consequatur dignissimos, quisquam dolorum rerum debitis fugit aperiam optio reiciendis. Est ab culpa velit provident nulla omnis fuga exercitationem!
    ...
    <?php
        ...
        if (!isset($_SESSION["permission"]) || $_SESSION["permission"] == 1) {
            ...
            $query = "SELECT * FROM RealEstates WHERE RealEstates.id IN (SELECT FavoriteRealEstates.idRealEstate FROM FavoriteRealEstates WHERE FavoriteRealEstates.userNameCustomer = '$userName') ";
            ...
            echo "<div class='box-title'> <h2 class='title-h2 title'>Bất động sản quan tâm</h2> </div>";
